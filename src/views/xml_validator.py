...
class XmlValidatorView(Adw.Bin):
    ...
    def _on_check_done(self, source_widget:GObject.Object, result:Gio.AsyncResult, user_data:GObject.GPointer):
        ...
        if outcome:
            ...
            self._check_lbl.set_text(_("XML is compliant with the provided XSD scheme."))
            ...
            self._check_lbl.set_text(_(f"XML is not compliant with the provided XSD scheme:\n{xsd_error}"))
